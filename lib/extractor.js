...
const getSource = function ($) {
  const availableSource1 = $("meta[name='application-name']").attr('content');
  const availableSource2 = $("meta[property='og:site_name']").attr('content');
  const availableSource3 = $("meta[property='twitter:site']").attr('content');
  const availableSource4 = $("meta[property='dc.title']").attr('content');
  if (availableSource1 !== '' && availableSource1 !== undefined && availableSource1 !== null) {
    return availableSource1;
  }
  if (availableSource2 !== '' && availableSource2 !== undefined && availableSource2 !== null) {
    return availableSource2;
  }
  if (availableSource3 !== '' && availableSource3 !== undefined && availableSource3 !== null) {
    return availableSource1;
  }
  if (availableSource4 !== '' && availableSource4 !== undefined && availableSource4 !== null) {
    return availableSource4;
  }
  return '';
};
